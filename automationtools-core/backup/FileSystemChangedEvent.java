package com.automationtools.core.event.filesystem;
...
public class FileSystemChangedEvent {
	...
	public FileSystemChangedEvent(Path parentPath, Path path, EventTypes event) {
		this.parentPath = parentPath;
		this.path = path;
		this.event = event.toWatchEventKind();
	}
	
	public FileSystemChangedEvent(Path parentPath, Path path, WatchEvent.Kind<?> event) {
		this.path = path;
		this.event = event;
		this.parentPath = parentPath;
	}
