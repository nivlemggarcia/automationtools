 ...
 * @since 	1.0.0
 */
public class DelayedHandler<T, R> extends HandlerDecorator<T, R> {
	 ...
	 */
	public DelayedHandler(TaskHandler<T, R> wrapped) {
		super(wrapped);
	}
	 ...
	 */
	public DelayedHandler(TaskHandler<T, R> wrapped, TimeUnit unit, long delay) {
		super(wrapped);
		this.unit = unit;
		this.delay = delay;
	}
	...
	public void setUnit(TimeUnit unit) {
		notNull(unit, "TimeUnit cannot be null");
		this.unit = unit;
	}
